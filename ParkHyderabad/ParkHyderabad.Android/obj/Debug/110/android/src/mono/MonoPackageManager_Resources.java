...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ParkHyderabad.Android.dll" comes first in this list. */
		"ParkHyderabad.Android.dll",
		...
		"Xamarin.Forms.GoogleMaps.Clustering.Android.dll",
		"Xamarin.Forms.GoogleMaps.Clustering.dll",
